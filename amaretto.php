...
<body>
    ...
    <main>
        ...
        <div class="main">
            ...
            <div class="card">
                <div class="title">
                    <h1>Disaronno Originale</h1>
                </div>
                <img src="img/disaronno.jpg" alt="Disaronno Originale">
            ...
            <div class="card">
                ...
                <img src="img/lazzaroni.jpg" alt="Lazzaroni">
            ...
            <div class="card">
                <div class="title">
                    <h1>Gozio Amaretto</h1>
                </div>
                <img src="img/gozio.jpg" alt="Gozio Amaretto">
            ...
            <div class="card">
                ...
                <img src="img/adriatico.jpg" alt="Adriatico">
            ...
            <div class="card">
                ...
                <img src="img/luxardo.jpg" alt="Luxardo">
            ...
            <div class="card">
                ...
                <img src="img/amarettosour.jpg" alt="Amaretto Sour">
            ...
            <div class="card">
                ...
                <img src="img/amarettofizz.jpg" alt="Amaretto Fizz">
                <p><a href="shippingaddress.php"><button name="one">Buy Now<p class="card-price">£6.23</p></button></a></p>
                <p><button name="two">Add to Cart</button></p>
            </div>
            <!--cards -->
            <div class="card">
                ...
                <img src="img/caffo.jpg" alt="Caffo">
                <p><a href="shippingaddress.php"><button name="one">Buy Now<p class="card-price">£2.2</p></button></a></p>
                <p><button name="two">Add to Cart</button></p>
            </div>
