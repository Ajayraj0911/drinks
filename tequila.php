...
<body>
    ...
    <main>
        ...
        <div class="main">
            ...
            <div class="card">
                <div class="title">
                    <h1>El Tesoro Anejo </h1>
                </div>
                <img src="img/el.jpg" alt="El Tesoro Anejo">
            ...
            <div class="card">
                ...
                <img src="img/patron.jpg" alt="Patrón Silver">
            ...
            <div class="card">
                <div class="title">
                    <h1>Hornitos Black Barrel</h1>
                </div>
                <img src="img/barrel.jpg" alt="Hornitos Black Barrel">
            ...
            <div class="card">
                <div class="title">
                    <h1>Clase Azul Reposado</h1>
                </div>
                <img src="img/clase.jpg" alt="Clase Azul Reposado">
            ...
            <div class="card">
                <div class="title">
                    <h1>Teremana Blanco</h1>
                </div>
                <img src="img/teremana.jpg" alt="Teremana Blanco">
            ...
            <div class="card">
                <div class="title">
                    <h1>Cazadores Blanco</h1>
                </div>
                <img src="img/cazadores.jpg" alt="Cazadores Tequila Blanco">
                <p><a href="shippingaddress.php"><button name="one">Buy Now<p class="card-price">£3.2</p></button></a></p>
                <p><button name="two">Add to Cart</button></p>
            </div>
            <!--cards -->
            <div class="card">
                <div class="title">
                    <h1>Don Julio Anejo</h1>
                </div>
                <img src="img/don.jpg" alt="Don Julio Anejo">
                <p><a href="shippingaddress.php"><button name="one">Buy Now<p class="card-price">£5.2</p></button></a></p>
                <p><button name="two">Add to Cart</button></p>
            </div>
            <!--cards -->
            <div class="card">
                <div class="title">
                    <h1>Milagro Silver</h1>
                </div>
                <img src="img/milagro.jpg" alt="Milagro Silver">
